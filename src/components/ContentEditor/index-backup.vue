...
<script lang="ts" setup>
  ...
  import cubefieldModule, {
    type CubefieldElement,
  } from '../../code-mirror/flow/richFieldEditor/module/cubeField';
  ...
  // 内容 HTML
  const valueHtml = ref('');
  // const publicUrl = '/api/rest/web/v1/platform/attachment/preview/';
  const publicUrl = '/platform/attachment/preview/';
  const editorConfig = {

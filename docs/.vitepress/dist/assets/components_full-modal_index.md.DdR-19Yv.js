...
<\/script>`,N={__name:"Drag",setup(g){const s=m(!1),l=()=>{console.log("点击确定"),s.value=!1},h=()=>{console.log("点击取消"),s.value=!1};return(c,a)=>{const p=u("a-button"),v=u("s-full-modal"),i=u("Demo");return w(),k(i,{code:T},{default:e(()=>[o("div",null,[n(p,{type:"primary",onClick:a[0]||(a[0]=f=>s.value=!0)},{default:e(()=>a[2]||(a[2]=[d("拖拽弹框")])),_:1,__:[2]}),n(v,{allowFullScreen:"",draggable:"",open:s.value,"onUpdate:open":a[1]||(a[1]=f=>s.value=f),title:"标题",onOk:l,onCancel:h},{default:e(()=>a[3]||(a[3]=[d(" 内容区域 ")])),_:1,__:[3]},8,["open"])])]),_:1})}}},A=JSON.parse('{"title":"FullModal 全屏弹窗","description":"","frontmatter":{},"headers":[],"relativePath":"components/full-modal/index.md","filePath":"components/full-modal/index.md"}'),U={name:"components/full-modal/index.md"},B=Object.assign(U,{setup(g){return(s,l)=>(w(),S("div",null,[l[0]||(l[0]=o("h1",{id:"fullmodal-全屏弹窗",tabindex:"-1"},[d("FullModal 全屏弹窗 "),o("a",{class:"header-anchor",href:"#fullmodal-全屏弹窗","aria-label":'Permalink to "FullModal 全屏弹窗"'},"​")],-1)),l[1]||(l[1]=o("p",null,"全屏弹窗组件，支持全屏拖拽。",-1)),l[2]||(l[2]=o("h3",{id:"基础用法",tabindex:"-1"},[d("基础用法 "),o("a",{class:"header-anchor",href:"#基础用法","aria-label":'Permalink to "基础用法"'},"​")],-1)),n(O),l[3]||(l[3]=o("h3",{id:"自定义渲染-slot使用",tabindex:"-1"},[d("自定义渲染(slot使用) "),o("a",{class:"header-anchor",href:"#自定义渲染-slot使用","aria-label":'Permalink to "自定义渲染(slot使用)"'},"​")],-1)),n(D),l[4]||(l[4]=o("h3",{id:"拖拽支持",tabindex:"-1"},[d("拖拽支持 "),o("a",{class:"header-anchor",href:"#拖拽支持","aria-label":'Permalink to "拖拽支持"'},"​")],-1)),l[5]||(l[5]=o("p",null,"沿用了官网的示例，这里仅需要配置 draggable 即可。",-1)),n(N),l[6]||(l[6]=P('<h2 id="api" tabindex="-1">API <a class="header-anchor" href="#api" aria-label="Permalink to &quot;API&quot;">​</a></h2><h3 id="props" tabindex="-1">Props <a class="header-anchor" href="#props" aria-label="Permalink to &quot;Props&quot;">​</a></h3><table tabindex="0"><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td>visible/open(v-model)</td><td>是否显示弹窗(visible部分历史兼容)</td><td>boolean</td><td>false</td></tr><tr><td>title</td><td>弹窗标题</td><td>string</td><td>-</td></tr><tr><td>width</td><td>弹窗宽度</td><td>string | number</td><td>450</td></tr><tr><td>height</td><td>弹窗高度</td><td>string | number</td><td>&#39;auto&#39;</td></tr><tr><td>max-height</td><td>最大高度</td><td>string</td><td>70vh</td></tr><tr><td>min-height</td><td>最小高度</td><td>string</td><td>100px</td></tr><tr><td>draggable</td><td>是否可拖动</td><td>boolean</td><td>false</td></tr><tr><td>needConfirmClose</td><td>是否需要二次确认(默认情况下，会触发cancel后自动关闭，如果有需求，设置后可以自定义取消逻辑)</td><td>boolean</td><td>false</td></tr></tbody></table><h3 id="antv的modal剩余-props-均能使用。" tabindex="-1">antv的modal剩余 <a href="https://www.antdv.com/components/modal-cn#api" target="_blank" rel="noreferrer">props</a> 均能使用。 <a class="header-anchor" href="#antv的modal剩余-props-均能使用。" aria-label="Permalink to &quot;antv的modal剩余 [props](https://www.antdv.com/components/modal-cn#api) 均能使用。&quot;">​</a></h3><h3 id="events" tabindex="-1">Events <a class="header-anchor" href="#events" aria-label="Permalink to &quot;Events&quot;">​</a></h3><table tabindex="0"><thead><tr><th>事件名称</th><th>说明</th><th>回调参数</th></tr></thead><tbody><tr><td>ok</td><td>点击确定回调</td><td>function(e)</td></tr><tr><td>cancel</td><td>点击取消或X的回调</td><td>function(e)</td></tr></tbody></table><h3 id="slots" tabindex="-1">Slots <a class="header-anchor" href="#slots" aria-label="Permalink to &quot;Slots&quot;">​</a></h3><table tabindex="0"><thead><tr><th>名称</th><th>说明</th></tr></thead><tbody><tr><td>default</td><td>弹窗内容</td></tr><tr><td>title</td><td>自定义标题</td></tr><tr><td>title-left</td><td>左侧标题</td></tr><tr><td>title-right</td><td>右侧操作(默认会显示关闭按钮)</td></tr><tr><td>footer</td><td>自定义底部</td></tr><tr><td>footer-left</td><td>自定义底部左侧</td></tr><tr><td>footer-right</td><td>自定义底部右侧</td></tr></tbody></table>',8))]))}});export{A as __pageData,B as default};
